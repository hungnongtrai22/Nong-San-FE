...
// types
import { ICategory, IProduct, IProductFilters, IProductFilterValue } from 'src/types/product';
// utils
...
function applyFilter({
  ...
  if (category !== 'all') {
    inputData = inputData.filter((product) => (product.category as ICategory).name === category);
  }
